...
import { ParamsType, apiCall, fetchStockDetails } from './stock-api'
...
describe("ParamsType", () => {
    ...
    it("should allow 'TIME_SERIES_DAILY' function with symbol", () => {
        const params: ParamsType = { function: "TIME_SERIES_DAILY", symbol: "AAPL" };
...
describe('apiCall', () => {
    it('should make a GET request to /query with the provided params', async () => {
        ...
        // ASSERT
        expect(mocks.get).toHaveBeenCalledWith({ url: '/query', method:'GET', params })
...
describe('fetchStockDetails', () => {
    it('should call apiCall with OVERVIEW function and symbol', async () => {
        ...
        // ASSERT
        expect(mocks.get).toHaveBeenCalledWith({ url: '/query', method:'GET', params: { function: 'OVERVIEW', symbol } })
